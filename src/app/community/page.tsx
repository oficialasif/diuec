...
import { MessageSquare, Share2, Send, Image as ImageIcon, MoreHorizontal, Globe, Clock, MessageCircle, ThumbsUp, Calendar, Users, Newspaper, ExternalLink, Bell } from 'lucide-react'
            ...
            {posts.map(post => (
              ...
              >
                ...
                <div className="p-4 flex justify-between items-start">
                  ...
                  <Button variant="ghost" size="icon" className="text-gray-400 hover:bg-[#3A3B3C] rounded-full">
                    <MoreHorizontal />
                  </Button>
                </div>
