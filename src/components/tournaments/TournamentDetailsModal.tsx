...
export function TournamentDetailsModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-sm overflow-y-auto">
            ...
            <button
                onClick={onClose}
                className="fixed top-6 right-6 z-[70] bg-black/50 p-2 rounded-full text-white hover:bg-white hover:text-black transition-all backdrop-blur-md border border-white/10 shadow-lg"
            >
                <X className="w-8 h-8" />
            </button>
            ...
            <motion.div
                ...
                className="bg-zinc-900 border border-zinc-800 rounded-2xl w-full max-w-4xl overflow-hidden relative shadow-2xl my-8"
            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 lg:divide-x divide-zinc-800">
                    ...
                    {/* Sidebar */}
                    <div className="p-8 bg-zinc-900/50 space-y-8">
                        {/* Action Box */}
